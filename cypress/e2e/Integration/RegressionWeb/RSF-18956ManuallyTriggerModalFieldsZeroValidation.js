...
describe('Manually Trigger modal fields validations for zero value', () => {
  it('Override amount and Other credit Fields validations for zero value', () => {
    ...
    customerestimates.manuallyTriggerFieldsValidation(customerestimates.zerovalue, customerestimates.zerovalue);
  });
  Cypress.on(
    'uncaught:exception',
    (_err, _runnable) =>
