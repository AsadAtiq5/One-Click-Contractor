...
describe('Signer Dropdown Validation', () => {
  it('Changing signer dropdown reinitializes recipient information', { tags: 'CustomerJob' }, () => {
    ...
    signature.titleDropdownVerification();
  });
