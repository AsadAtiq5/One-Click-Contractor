...
describe('CostOfLineItemOptions', () => {
  it('Verify Cost Of Line Item Options', { tags: 'CustomerJob' }, () => {
    ...
    customerestimates.productOptionEstimateLineItems();
    customerestimates.saveEstimate();
    customerestimates.newEstimateAssertion();
    customerestimates.costSheetVerify();
  });
