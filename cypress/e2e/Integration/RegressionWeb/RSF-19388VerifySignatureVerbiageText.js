...
describe('VerifyConfigurationVerbiageTextOnSignatureDoc', () => {
  it('Verify Configuration Verbiage Text On Signature Doc', { tags: 'Regression' }, () => {
    ...
    signature.verifySignerVerbiageText();
  });
