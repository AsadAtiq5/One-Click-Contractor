...
describe('Org WITHOUT NetSuite enabled, Not having manual_trigger option', () => {
  it('User without estimate.manual_trigger will NOT see the option', { tags: 'Regression' }, () => {
    const login = new Login();
    const viewCustomerMenuOptions = new ViewCustomerMenuOptions();
    const jobInformation = new Jobinformation();
    const customerestimates = new CustomerEstimates();

    login.setLoginEmailAndPasswordUsingApi('netsuitedisabledscenerio2@gmail.com', '12345');
    login.visitPage();
